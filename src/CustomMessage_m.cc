...
CustomMessage::CustomMessage(const char *name, short kind) : ::omnetpp::cPacket(name, kind)
{
}

CustomMessage::CustomMessage(const CustomMessage& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
CustomMessage& CustomMessage::operator=(const CustomMessage& other)
{
...
void CustomMessage::copy(const CustomMessage& other)
{
...
void CustomMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
...
void CustomMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
...
char CustomMessage::getM_Header() const
{
    return this->M_Header;
}

void CustomMessage::setM_Header(char M_Header)
{
    this->M_Header = M_Header;
}

const char * CustomMessage::getM_Payload() const
{
    return this->M_Payload.c_str();
}

void CustomMessage::setM_Payload(const char * M_Payload)
{
    this->M_Payload = M_Payload;
}

char CustomMessage::getM_Trailer() const
{
    return this->M_Trailer;
}

void CustomMessage::setM_Trailer(char M_Trailer)
{
    this->M_Trailer = M_Trailer;
}

int CustomMessage::getM_Type() const
{
    return this->M_Type;
}

void CustomMessage::setM_Type(int M_Type)
{
    this->M_Type = M_Type;
}
...
CustomMessageDescriptor::CustomMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(CustomMessage)), "omnetpp::cPacket")
{
...
{
    return dynamic_cast<CustomMessage *>(obj)!=nullptr;
}
...
int CustomMessageDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    ...
    CustomMessage *pp = omnetpp::fromAnyPtr<CustomMessage>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}
...
void CustomMessageDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    ...
    CustomMessage *pp = omnetpp::fromAnyPtr<CustomMessage>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'CustomMessage'", field);
    }
}
...
omnetpp::cValue CustomMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'CustomMessage' as cValue -- field index out of range?", field);
    }
}
